...
class SummaryWidgetView extends View {
    ...
    initialize(){
        this.listenTo(settings, 'change:totalResultSelectOption', this.render);
        this.listenTo(settings, 'change:isCoverageChecked', this.render);
    ...
    serializeData() {
        ...
        this.currentOptionId = settings.get('totalResultSelectOption');
        this.isCoverageChecked = settings.get('isCoverageChecked');
