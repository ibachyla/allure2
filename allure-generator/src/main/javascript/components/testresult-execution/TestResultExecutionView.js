...
class TestResultExecutionView extends View {
    ...
    initialize() {
        ...
        this.listenTo(settings, 'change:stepDisplayParams', this.updateSteps);
    }
    ...
    serializeData() {
        this.stepDisplayParams = settings.get('stepDisplayParams');
    ...
    updateSteps() {
        var stepDisplayParams = settings.get('stepDisplayParams');
